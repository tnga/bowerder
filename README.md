...
Bowerder will load by default the latest version of a package, but developer can target a version to load (https://semver.org); however it will be only considered by the loader with this online loading mode through CDN.
